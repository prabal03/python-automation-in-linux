...
gpgcheck=0""")
            ...
            def ec2():
                ...
                if y==1:
                    ...
                    os.system("aws ec2 run-instances --image-id ami-0d0522ed4db1debd6  --count 1 --instance-type t2.micro --key-name  Mykeyn  --security-groups MySecurityGroupn")
                elif y==4:
                    os.system("aws ec2 run-instances --image-id  ami-0cda377a1b884a1bc  --count 1 --instance-type t2.micro --key-name  Mykeyn  --security-groups MySecurityGroupn")
                    print("\n\-------------------Your Ubuntu Instance has been launched---------------")
                elif y==5:
                    os.system("aws ec2 run-instances --image-id  ami-0b2f6494ff0b07a0e  --count 1 --instance-type t2.micro --key-name  Mykeyn  --security-groups MySecurityGroupn")
                    print("\n\-------------------Your Window Server has been launched---------------")
                elif y==6:
                    os.system("aws ec2 run-instances --image-id  ami-0295b81b270caa9d2 --count 1 --instance-type t2.micro --key-name  Mykeyn  --security-groups MySecurityGroupn")
                    print("\n\-------------------Your Window Server With Containers has been launched---------------")
                elif y==2:
                    os.system("aws ec2 run-instances --image-id ami-052c08d70def0ac62  --count 1 --instance-type t2.micro --key-name  Mykeyn  --security-groups MySecurityGroupn;tput setaf 3;echo '---------------RHEL8 MACHINE HAS BEEN LAUNCHED --------'")
                elif y==7:
